...
def analyze_ratios(pe_ratio, pb_ratio, dividend_yield, payout_ratio, expense_ratio):
...
recommend = analyze_ratios(pe_ratio, pb_ratio, dividend_yield, payout_ratio, expense_ratio)
if recommend:
